...
st.write('Pulled the counts of articles in OpenAlex for 2,882 Gold journals as defined in the APC dataset, looking at years 2019-2023. Data was ISSN, Year, DocType, and Count.')
...
fig2 = px.scatter(merged_wide, x='count_Dimensions', y='count_OpenAlex',
                 ...
                 title='X-Y Scatterplot of 2884 Gold ISSNs*5years<br>Research+Review Counts, Dimensions vs. OpenAlex (new Doctypes)')
